...
Last updated: 2026-04-19 (v0.2 Session 13 complete — Audiobookshelf sync pipeline + timeline writer landed; `/api/sync/audiobookshelf/plan` + `/apply` wired, 503 when disabled; UI deferred to Session 14)
...
### v0.2 — Audiobookshelf sync (3 sessions; Sessions 12, 13 shipped 2026-04-19)
